...
export async function POST(req) {
  try {
    ...
    const response = await client.messages.create({
      ...
      max_tokens: 1024,
      system: `You are Edna, a friendly and knowledgeable AI assistant for the Smart Farming Network (SFN).
...
- Information about the SFN platform (marketplace, profiles, dashboards)
...
If someone asks something outside agriculture or the SFN platform, gently steer them back to farming topics.
